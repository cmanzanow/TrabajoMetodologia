			...
			<div id="top-header">
				<div class="container">
					<ul class="header-links">
						<li><a id="a1" href="Controlador/Login.php"><i class="fa fa-sign-in" aria-hidden="true"></i> Iniciar Sesión</a></li>
						<li><a id="a2" href="Controlador/Registro2.php"><i class="fa fa-sign-out"></i> Regístrate </a></li>
					</ul>
				</div>
			</div>
  </header>
