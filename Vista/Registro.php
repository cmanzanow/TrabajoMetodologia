...
<html lang="en">
    ...
    <body>
        ...
        <div id="asd">
        <a href="../Controlador/Login.php" class="botox"><p><br><img alt="Volver al menu inicial" height="100" onmouseout="this.src='../Assets/imagen/boton1.png';" onmouseover="this.src='../Assets/imagen/boton2.png';" src="../Assets/imagen/boton1.png" /></p></a>
        </div>
            ...
            <div class="wrapper">
                ...
                <form action="../Controlador/Exito.php?usuario=--><?php echo"inicio";?>" method="post" class="form-wrapper" onsubmit= "return validar_formulario()">
                    <fieldset class="section is-active">
                        ...
                        <div class="volver"><a href="../Controlador/Login.php">Volver</a></div>
